      ...
      <div className="container-shell section-pad">
        ...
        <div className="section-stack grid gap-4 md:grid-cols-2 md:gap-4">
          ...
          >
            ...
            <h3 className="font-display mt-3 text-3xl leading-tight">Ιδιαίτερα</h3>
            <p className="mt-2 text-cream/65">8 ώρες / μήνα</p>
            <div className="mt-4 flex items-end gap-3">
              <p className="font-display text-5xl text-yellow lg:text-6xl">
          ...
          <motion.article
            className="group relative overflow-hidden rounded-[2rem] border-[3px] border-ink bg-paper p-6 shadow-[8px_8px_0_#3d8bff] md:p-7"
            whileHover={{ y: -6 }}
          >
            ...
            <h3 className="font-display mt-3 text-3xl leading-tight">Ομαδικά</h3>
            <p className="mt-2 text-ink/60">
              3–4 άτομα · 8 ώρες / μήνα
            </p>
            <div className="mt-4 flex items-end gap-3">
              <p className="font-display text-5xl text-blue lg:text-6xl">
